        ...
        if (_selectedRoleTab == 0)
          ...
          Wrap(
            ...
            children: [
              ...
              _accountChip('III-D: Mr. Veluswamy', 'advisor.veluswamy', 'Adv@Velu3D'),
...
class _CredentialsDirectoryDialogState extends State<_CredentialsDirectoryDialog>
  ...
  Widget _buildAdvisorList() {
    final advisors = [
      ...
      {'name': 'Mr. Veluswamy', 'class': 'III AI&DS - Section D', 'username': 'advisor.veluswamy', 'password': 'Adv@Velu3D', 'role': UserRole.advisor},
