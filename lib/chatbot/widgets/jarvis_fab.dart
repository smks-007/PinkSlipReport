...
class _JarvisChatDrawerState extends State<_JarvisChatDrawer> with SingleTickerProviderStateMixin {
  ...
  late final List<Map<String, String>> _messages = [
    {
      'sender': 'jarvis',
      'text': '🤖 **Greetings Dr. HOD! I am Smart Pro AI Co-Pilot & Autonomous Agent**.\n\nI have complete trained memory of all **${MockDataService.totalStrength} students** across all ${MockDataService.getAvailableSections().length} sections, Section Class Advisors, the Academic Calendar, live attendance records, OD approvals, and <75% attendance defaulters.\n\n💡 *Tip: Give any student name or roll number or switch to **Autonomous AI-Agent Mode** to execute administrative actions!*'
    }
  ];
                      ...
                      if (isJarvis) ...[
                        if (msg['text']!.contains('Decision Queue') || msg['text']!.contains('awaiting your digital signature')) ...[
                          ...
                          ElevatedButton.icon(
                            ...
                            onPressed: () => _triggerAgentFromChat('Generate daily department executive brief across all students and sections'),
                          ),
            ...
            children: [
              ...
              Expanded(
                child: _agentActionBtn(
                  ...
                  subtitle: '${MockDataService.totalStrength}-student telemetry',
                  icon: Icons.analytics_outlined,
                  color: const Color(0xFF2563EB),
                  onTap: () => _runAgentGoal('Generate daily department executive brief across all students and sections'),
                ),
              ),
            ],
          ),
